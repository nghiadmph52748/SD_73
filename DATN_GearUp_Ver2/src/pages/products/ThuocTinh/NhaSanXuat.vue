<template>
  <div class="nha-san-xuat-page thuoc-tinh-page">
    ...
    <div class="card">
      <div class="card-header">
        <div class="table-header-content">
          <h3 class="table-title">Danh sách nhà sản xuất</h3>
        </div>
      </div>
      <div class="card-body">
        <TableContainer>
          <thead>
            <tr>
              ...
              <th class="col-lg ta-left">Tên nhà sản xuất</th>
          ...
          <tbody>
            <tr v-for="(value, i) in paginatedNhaSanXuats" :key="i">
              ...
              <td class="ta-left truncate">{{ value.tenNhaSanXuat }}</td>
...
<img src="../../../assets/Trash.svg" alt="Delete" class="icon-action-svg" />
        ...
        <div
          v-else-if="filteredNhaSanXuats.length > 0"
          class="pagination-wrapper"
        >
          <div class="pagination-info">
            Hiển thị tất cả {{ filteredNhaSanXuats.length }} nhà sản xuất
          </div>
        </div>
      </div>
          ...
          <div class="modal-body">
            <div class="delete-content">
              ...
              <p class="delete-message">
                Bạn sắp xóa nhà sản xuất
                <strong>"{{ deleteItemName }}"</strong>. Hành động này không thể
                hoàn tác.
              </p>
            </div>
          </div>
