<template>
  <div class="chat-lieu-page thuoc-tinh-page">
    ...
    <div class="card">
      <div class="card-header">
        <div class="table-header-content">
          <h3 class="table-title">Danh sách chất liệu</h3>
        </div>
      </div>
      <div class="card-body">
        ...
        <div
          v-else-if="filteredChatLieus.length > 0"
          class="pagination-wrapper"
        >
          <div class="pagination-info">
            Hiển thị tất cả {{ filteredChatLieus.length }} chất liệu
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="modal-body">
          <div class="delete-content">
            ...
            <p class="delete-message">
              Bạn sắp xóa chất liệu <strong>"{{ deleteItemName }}"</strong>.
